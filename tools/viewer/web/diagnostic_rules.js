...
(function (root, factory) {
  ...
  root.OpenFPGADiagnosticRules = api;
  ...
  function evaluate(snapshot, config = {}, baseline = {}) {
    ...
    return { schema: "openfpga.diagnostic_findings", schema_version: VERSION, rule_set_version: VERSION, snapshot_id: snapshot.snapshot_id, findings: output, skipped };
  }
