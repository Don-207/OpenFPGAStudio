...
assign msg_ready = (state == STATE_IDLE) && !out_valid && (payload_len <= `OFD_MAX_PAYLOAD_BYTES);

always @(*) begin
    checksum_value = `OFD_VERSION ^ latched_type ^ latched_len;
