...
openfpga_debug_timestamp u_timestamp (
    .clk(clk),
    .rst(rst),
    .timestamp(timestamp)
);
...
always @(*) begin
    ...
    if (monitor_msg_valid) begin
        ...
        fifo_wr_valid = 1'b1;
        fifo_wr_type = `OFD_TYPE_DEBUG_PRINT;
        fifo_wr_len = 8'd14;
        fifo_wr_payload[31:0] = timestamp;
        ...
        fifo_wr_valid = 1'b1;
        fifo_wr_type = `OFD_TYPE_HEARTBEAT;
        fifo_wr_len = 8'd4;
        fifo_wr_payload[31:0] = timestamp;
    end else if (status_valid) begin
        fifo_wr_valid = 1'b1;
        fifo_wr_type = `OFD_TYPE_STATUS;
        fifo_wr_len = 8'd10;
        fifo_wr_payload[31:0] = timestamp;
...
openfpga_trace_adapter u_trace_adapter (
    .clk(clk),
    .rst(rst),
    .timestamp(timestamp),
