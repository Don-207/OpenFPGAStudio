...
#   into openfpga_debug_board_demo until M25, so this script keeps the existing
...
set bit_file [file join $impl_dir openfpga_debug_board_demo_m23.bit]
set timing_file [file join $impl_dir openfpga_debug_board_demo_m23_timing_summary_routed.rpt]
set route_file [file join $impl_dir openfpga_debug_board_demo_m23_route_status.rpt]
set drc_file [file join $impl_dir openfpga_debug_board_demo_m23_drc_routed.rpt]
set util_file [file join $impl_dir openfpga_debug_board_demo_m23_utilization_routed.rpt]
set top_name openfpga_debug_board_demo
...
puts "PASS: Built OpenFPGA M23-compatible board demo bitstream: $bit_file"
