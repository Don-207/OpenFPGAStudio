# Rebuild the OpenFPGA Debug board demo with an ILA on monitor RX path.
# Usage:
#   vivado -mode batch -source prj/scripts/build_openfpga_debug_board_demo_ila.tcl
#
...
set bit_file [file join $impl_dir openfpga_debug_board_demo_ila.bit]
set ltx_file [file join $impl_dir openfpga_debug_board_demo_ila.ltx]
...
puts "PASS: Rebuilt OpenFPGA Debug board demo ILA bitstream: $bit_file"
