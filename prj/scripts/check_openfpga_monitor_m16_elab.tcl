...
synth_design -rtl -name openfpga_monitor_m16_rtl -top openfpga_debug_board_demo -part xcku5p-ffvb676-2-i

puts "PASS: OpenFPGA Monitor M16 board demo Vivado RTL elaboration completed"
