...
synth_design -rtl -name openfpga_trace_m10_rtl -top openfpga_debug_board_demo -part xcku5p-ffvb676-2-i

puts "PASS: OpenFPGA Trace M10 probe and demo Vivado RTL elaboration completed"
