# Rebuild the OpenFPGA Debug board demo bitstream from the current RTL.
# Usage:
...
set impl_dir [file join $repo_root prj OpenFPGAStudio.runs impl_1]
set bit_file [file join $impl_dir openfpga_debug_board_demo.bit]
...
read_verilog -sv [list \
    [file join $rtl_debug_dir openfpga_jtag_ring_buffer.sv] \
    [file join $rtl_debug_dir openfpga_jtag_mailbox.sv] \
    [file join $rtl_debug_dir openfpga_jtag_transport.sv] \
    [file join $rtl_debug_dir openfpga_jtag_user_dr.sv] \
    [file join $repo_root rtl vendor xilinx openfpga_jtag_bscan_xilinx.sv] \
    [file join $repo_root rtl vendor xilinx openfpga_jtag_transport_xilinx.sv] \
]
read_xdc $xdc_file

synth_design -top openfpga_debug_board_demo -part xcku5p-ffvb676-2-i
opt_design
place_design
route_design
...
puts "PASS: Rebuilt OpenFPGA Debug board demo bitstream: $bit_file"
