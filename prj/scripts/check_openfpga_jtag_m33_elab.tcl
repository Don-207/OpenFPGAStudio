...
read_verilog -sv [file join $root_dir rtl/openfpga_debug/openfpga_transport_router.sv]
read_verilog -sv [file join $root_dir rtl/openfpga_debug/openfpga_jtag_ring_buffer.sv]
read_verilog -sv [file join $root_dir rtl/openfpga_debug/openfpga_jtag_mailbox.sv]
read_verilog -sv [file join $root_dir rtl/openfpga_debug/openfpga_jtag_transport.sv]
read_verilog -sv [file join $root_dir rtl/openfpga_debug/openfpga_jtag_user_dr.sv]
read_verilog -sv [file join $root_dir rtl/vendor/xilinx/openfpga_jtag_bscan_xilinx.sv]
read_verilog -sv [file join $root_dir rtl/vendor/xilinx/openfpga_jtag_transport_xilinx.sv]

synth_design -name openfpga_jtag_m33_synth -top openfpga_jtag_transport -part $part_name
...
set cdc_report_path [file join $root_dir prj/openfpga_jtag_m33_cdc.rpt]
