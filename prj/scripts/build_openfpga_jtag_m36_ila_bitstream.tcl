...
set rtl_debug [file join $repo_root rtl openfpga_debug]
...
if {$perf_mode} {
    ...
    set artifact_stem openfpga_debug_board_demo_m36_ila
}
set out_dir [file join $repo_root prj OpenFPGAStudio.runs $build_name]
