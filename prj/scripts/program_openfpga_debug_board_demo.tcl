# Program the current OpenFPGA Debug board demo bitstream over JTAG.
# Usage (target filter is mandatory):
#   vivado -mode batch -source prj/scripts/program_openfpga_debug_board_demo.tcl -tclargs *210308A1*

set script_dir [file normalize [file dirname [info script]]]
set repo_root [file normalize [file join $script_dir .. ..]]
set bit_file [file join $repo_root prj OpenFPGAStudio.runs impl_1 openfpga_debug_board_demo.bit]
