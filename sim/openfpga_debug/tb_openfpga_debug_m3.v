...
openfpga_debug_packetizer u_packetizer (
    .clk(clk),
    .rst(rst),
...
task expect_packet;
    ...
    check(bytes[0] == OFD_SOF, "packet SOF mismatch");
    check(bytes[1] == OFD_VERSION, "packet version mismatch");
...
initial begin
    ...
    seq_write(OFD_TYPE_EVENT, 8'd11, 16'h2001);
    seq_write(OFD_TYPE_WATCH, 8'd10, 16'h2002);
    seq_write(OFD_TYPE_DEBUG_PRINT, 8'd14, 16'h2003);
    expect_packet(OFD_TYPE_EVENT, 8'd11, 16'h2001);
    expect_packet(OFD_TYPE_WATCH, 8'd10, 16'h2002);
    expect_packet(OFD_TYPE_DEBUG_PRINT, 8'd14, 16'h2003);
