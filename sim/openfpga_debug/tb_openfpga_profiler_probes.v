...
module tb_openfpga_profiler_probes;
...
openfpga_profiler_frame_probe u_frame_probe (
    .clk(clk),
    .rst(rst),
    .clear(clear),
    .enable(enable),
...
initial begin
    ...
    check(axis_metric_id == `OFD_PROFILER_METRIC_AXIS_DEMO_THROUGHPUT, "AXIS metric id mismatch");
    ...
    if (errors == 0) begin
        $display("PASS: OpenFPGA Profiler M19 probe checks passed");
    end else begin
