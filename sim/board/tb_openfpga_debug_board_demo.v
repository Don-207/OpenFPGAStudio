...
module tb_openfpga_debug_board_demo;
...
localparam [7:0] OFD_SOF = 8'hA5;
localparam [7:0] OFD_VERSION = 8'h01;
localparam [7:0] OFD_TYPE_HEARTBEAT = 8'h01;
localparam [7:0] OFD_TYPE_DEBUG_PRINT = 8'h02;
localparam [7:0] OFD_TYPE_EVENT = 8'h03;
localparam [7:0] OFD_TYPE_WATCH = 8'h04;
localparam [7:0] OFD_TYPE_STATUS = 8'h05;
localparam [7:0] OFD_TYPE_TRACE_SPAN_BEGIN = 8'h10;
localparam [7:0] OFD_TYPE_TRACE_SPAN_END = 8'h11;
localparam [7:0] OFD_TYPE_TRACE_MARK = 8'h12;
localparam [7:0] OFD_TYPE_TRACE_VALUE = 8'h13;
...
initial begin
    ...
    if (errors == 0) begin
        $display("PASS: OpenFPGA Debug board demo emitted debug and trace frames");
    end else begin
