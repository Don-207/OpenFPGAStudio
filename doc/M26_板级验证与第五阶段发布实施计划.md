...
```text
doc/
  OpenFPGA_Studio_第五阶段OpenLogicAnalyzer验证记录.md
  OpenFPGA_Studio_第五阶段OpenLogicAnalyzer发布Checklist.md
...
- [ ] `doc/OpenFPGA_Debug_Protocol_v1.md` 已补齐 LA 类型和 payload。
- [ ] Parser 回归测试通过。
...
- [ ] `doc/OpenFPGA_LogicAnalyzer_使用说明.md` 完成。
- [ ] 验证记录完成。
- [ ] 发布 checklist 完成。
- [ ] Bitstream 构建完成。
- [ ] 板级 30 分钟长稳通过。
...
`doc/OpenFPGA_Studio_第五阶段OpenLogicAnalyzer发布Checklist.md` 建议包含：
