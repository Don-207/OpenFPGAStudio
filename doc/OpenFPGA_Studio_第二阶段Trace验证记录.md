...
- Windows Microsoft Edge `150.0.4078.65`正式版本（64位）板级截图确认91个span、93个mark、31个value，Frame/DMA/FIFO/Interrupt四泳道均可见，DMA timeout为红色problem高亮。
...
- 第二阶段Trace的WP3复核完成，无PENDING或FAIL项。
