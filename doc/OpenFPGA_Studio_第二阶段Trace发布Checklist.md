...
- [ ] **PENDING** 将当前M36 JTAG+ILA候选bitstream下载到目标板，并记录板卡/cable/build ID。
...
文档、RTL、Viewer、软件回归、XSim、Vivado elaboration和候选镜像构建均为PASS。第二阶段Trace不能单独标记为当前v1.0板级发布完成，剩余阻塞为候选bitstream下载、Viewer连接与人工泳道/异常高亮确认、以及`drop_count`记录。
